...
(local opts {: home
             ...
             :template_new_note (.. home "/" :templates/note.norg)
             ;; template for newly created daily notes (goto_today)
             ;; set to `nil` or do not specify if you do not want a template
             :template_new_daily (.. home "/" :templates/daily.norg)
             ;; template for newly created weekly notes (goto_thisweek)
             ;; set to `nil` or do not specify if you do not want a template
             :template_new_weekly (.. home "/" :templates/weekly.norg)
             ;; image link style
             ;; wiki:     ![[image name]]
