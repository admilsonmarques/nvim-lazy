...
local plugins = {marks = true, registers = true, spelling = {enabled = true, suggestions = 20}, presets = {z = true, g = true, nav = false, text_objects = false, operators = false, motions = false, windows = false}}
