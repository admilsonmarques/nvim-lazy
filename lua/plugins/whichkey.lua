...
local plugins = {marks = true, registers = true, spelling = {enabled = true, suggestions = 20}, presets = {z = true, g = true, nav = false, windows = false, motions = false, operators = false, text_objects = false}}
