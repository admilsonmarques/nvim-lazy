...
local view = {width = 30, side = "left", adaptive_size = true, signcolumn = "yes", hide_root_folder = false, number = false, relativenumber = false}
...
local log = {types = {diagnostics = false, copy_paste = false, config = false, git = false, profile = false, all = false}, enable = false, truncate = false}
