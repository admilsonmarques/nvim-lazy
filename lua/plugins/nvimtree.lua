...
local view = {width = 30, side = "left", adaptive_size = true, signcolumn = "yes", number = false, hide_root_folder = false, relativenumber = false}
...
local log = {types = {config = false, copy_paste = false, all = false, profile = false, git = false, diagnostics = false}, enable = false, truncate = false}
