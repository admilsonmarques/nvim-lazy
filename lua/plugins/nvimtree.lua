...
local view = {width = 30, side = "left", adaptive_size = true, signcolumn = "yes", relativenumber = false, hide_root_folder = false, number = false}
...
local log = {types = {diagnostics = false, profile = false, git = false, copy_paste = false, config = false, all = false}, truncate = false, enable = false}
