...
local view = {width = 30, side = "left", adaptive_size = true, signcolumn = "yes", number = false, relativenumber = false, hide_root_folder = false}
...
local log = {types = {profile = false, copy_paste = false, diagnostics = false, git = false, all = false, config = false}, enable = false, truncate = false}
